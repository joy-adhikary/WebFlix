    ...
    <div className='contact'>
      ...
      <div className='flex flex-col'>
        ...
        <div className="flex py-10  ">
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-2xl  drop-shadow-xl p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
            <h2 className="text-gray-900 text-xl font-semibold text-center mb-1 font-medium title-font">Feedback</h2>
            ...
            <button className="text-white w-36 text-center rounded-full bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
